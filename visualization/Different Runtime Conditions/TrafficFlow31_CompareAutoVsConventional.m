...
x1A = csvread('PosProg0A.csv');               
y1A = x1A(1,1:end-1)*0 + 0;         
x2A = csvread('PosProg1A.csv');               
y2A = x2A(1,1:end-1)*0 + 0;
x3A = csvread('PosProg2A.csv');               
y3A = x3A(1,1:end-1)*0 + 0;         
x4A = csvread('PosProg3A.csv');               
y4A = x4A(1,1:end-1)*0 + 0;         
x5A = csvread('PosProg4A.csv');               
y5A = x5A(1,1:end-1)*0 + 0;
